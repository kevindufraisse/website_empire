...
const PLAN_TASKS: Record<PlanId, { tasks: Task[]; totalHours: string; totalCost: string; price: number }> = {
  starter: {
    tasks: [
      ...
      { fr: 'Community manager (correction, relecture, publication)', en: 'Community manager (QA, proofreading, publishing)', hours: '15h', cost: '750€' },
    ],
    totalHours: '106h',
    totalCost: '5 500€',
    price: 199,
  ...
  growth: {
    tasks: [
      ...
      { fr: 'Veille sujets viraux', en: 'Viral topic research', hours: '6h', cost: '300€' },
      { fr: 'Community manager (correction, relecture, publication)', en: 'Community manager (QA, proofreading, publishing)', hours: '25h', cost: '1 250€' },
    ],
    totalHours: '186h',
    totalCost: '9 180€',
    price: 499,
  ...
  scale: {
    tasks: [
      ...
      { fr: 'Veille sujets viraux', en: 'Viral topic research', hours: '6h', cost: '300€' },
      { fr: 'Community manager (correction, relecture, publication)', en: 'Community manager (QA, proofreading, publishing)', hours: '40h', cost: '2 000€' },
    ],
    totalHours: '272h',
    totalCost: '13 220€',
    price: 799,
