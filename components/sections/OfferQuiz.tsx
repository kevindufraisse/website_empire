...
const RESULTS: Record<OfferId, {
  ...
  empire: {
    ...
    labelFr: 'Empire',
    labelEn: 'Empire',
    titleFr: 'Développez une marque personnelle qui attire des clients.',
    titleEn: 'Build a personal brand that attracts clients.',
  ...
  legende: {
    ...
    labelFr: 'Légende',
    labelEn: 'Legend',
    titleFr: 'Déléguez votre marque personnelle aux meilleurs experts en viralité.',
    titleEn: 'Delegate your personal brand to the best virality experts.',
