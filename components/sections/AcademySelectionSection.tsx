        ...
        <div className="max-w-4xl mx-auto">
          ...
          <FadeInBlock>
            <div className="text-center mb-12">
              <p className="text-xs font-bold text-academy tracking-widest uppercase mb-3">Sur sélection</p>
          ...
          <FadeInBlock delay={0.3}>
            <div className="text-center">
              ...
              <p className="text-xs text-neutral-400 mt-2">Formulaire de 2 min · Réponse sous 48h · Aucun engagement</p>
            </div>
          </FadeInBlock>
