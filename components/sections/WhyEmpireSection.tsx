    ...
    ? [
        {
          ...
          phrase: 'Chaque mois sans présence en ligne, c\'est des dizaines de leads qui vont chez vos concurrents. L\'audience se construit sur la durée — plus vous commencez tôt, plus l\'avantage est cumulatif.',
          stat: '10-20',
          statLabel: 'RDV/sem perdus',
        },
        {
          direction: 'up' as const,
          color: '#ef4444',
          label: 'Concurrence sur les réseaux',
          phrase: 'Le volume de contenu publié chaque jour explose. Les algorithmes favorisent ceux qui postent régulièrement. Attendre, c\'est perdre de la visibilité au profit de ceux qui sont déjà actifs.',
          stat: '+40%',
          statLabel: 'de contenu/an sur LinkedIn',
        },
      ]
    : [
        {
          ...
          phrase: 'Every month without an online presence means dozens of leads going to your competitors. Audience builds over time — the earlier you start, the bigger your compounding advantage.',
          stat: '10-20',
          statLabel: 'meetings/wk lost',
        },
        {
          direction: 'up' as const,
          color: '#ef4444',
          label: 'Social media competition',
          phrase: 'The volume of content published daily is exploding. Algorithms favor consistent posters. Waiting means losing visibility to those who are already active.',
          stat: '+40%',
          statLabel: 'more content/yr on LinkedIn',
        },
      ]
      ...
      <div ref={ref} className="relative z-10 px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        >
          <p className="text-base md:text-lg text-neutral-400 max-w-2xl mx-auto leading-relaxed mb-6">
            {fr ? (
              <>
                Avec Empire, vous partez avec <span className="text-white font-semibold">des années d&apos;avance</span> sur ceux qui débutent.
                <br />
                Ne perdez pas 1 an à tester seul - ce sera trop tard.
              </>
            ) : (
              <>
                With Empire, you start <span className="text-white font-semibold">years ahead</span> of those just getting started.
                <br />
