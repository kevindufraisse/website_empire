    ...
    <section id="academy-pricing" className="relative w-full py-20 md:py-28 bg-gradient-to-b from-[#0f0f0f] to-black overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="max-w-2xl mx-auto">
          ...
          {/* Value anchor - DIY cost */}
          <FadeInBlock>
            <div className="mb-8 p-6 rounded-2xl bg-white/[0.03] border border-white/10">
              <p className="text-xs font-bold text-neutral-500 tracking-widest uppercase mb-4">Si tu fais tout toi-même</p>
              <div className="space-y-2.5">
                {diyComparison.map((row, i) => (
                  <div key={i} className="flex items-center justify-between">
                    <span className="text-sm text-neutral-400">{row.item}</span>
                    <span className="text-sm text-neutral-500 font-mono">{row.cost}</span>
                  </div>
                ))}
                <div className="pt-3 mt-3 border-t border-white/10 flex items-center justify-between">
                  <span className="text-sm text-white font-semibold">Total</span>
                  <span className="text-lg text-white font-black">4 160€+</span>
                </div>
              </div>
            </div>
          </FadeInBlock>
            ...
            <div className="relative p-8 md:p-10 rounded-2xl bg-gradient-to-br from-empire/20 to-empire/5 border border-empire shadow-[0_0_50px_rgba(218,252,104,0.15)] flex flex-col overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-center text-xs text-neutral-500 mb-4">
                  Le prix est communiqué après validation de ta candidature.
                </p>
