...
export default function MobileAppSection() {
  ...
  const points: { fr: [string, string]; en: [string, string] }[] = [
    {
      fr: ['Tous les formats, depuis le téléphone', 'Tier list, réaction, citation, podcast, interview : tout se tourne dans l\'app, cadre et consignes à l\'écran.'],
    ...
    },
    {
      ...
      en: ['Without showing your face', 'Dictation mode: you talk, no camera. A Telegram voice note works too.'],
    },
    {
      fr: ['Tout est prêt quand vous rouvrez l\'app', 'Monté, écrit, relu par un humain. Il reste un bouton : publier.'],
      en: ['Everything is ready when you reopen the app', 'Edited, written, proofread by a human. One button left: publish.'],
    },
  ]
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            <p className="mb-3 flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-empire">
              ...
              {fr ? 'La formule · 4. Le temps · L\'app iPhone' : 'The formula · 4. Time · The iPhone app'}
            </p>
