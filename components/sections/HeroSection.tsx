          ...
          {lang === 'fr' && (
            ...
            >
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-neutral-900/50 backdrop-blur-sm" style={{ paddingBottom: '56.25%' }}>
                <iframe
                  src="https://www.loom.com/embed/9751f76501dc436f8728f46736d7aea8?hideEmbedTopBar=true&autoplay=1&muted=1&hide_owner=true&hide_share=true&hide_speed=true&hide_title=true"
                  frameBorder="0"
                  allowFullScreen
                  allow="autoplay"
