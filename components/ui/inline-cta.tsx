  ...
  if (variant === 'minimal') {
    return (
      <div className="text-center py-8">
        ...
        <OnboardingLink className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-empire/10 border border-empire/30 text-empire font-bold hover:bg-empire/20 hover:gap-3 transition-all">
  ...
  if (variant === 'urgency') {
    return (
      <div className="p-6 rounded-xl bg-gradient-to-br from-red-500/10 to-transparent border border-red-500/30 text-center">
        ...
        <OnboardingLink className="inline-block px-6 py-3 bg-empire text-black font-bold rounded-lg hover:scale-105 transition-all">
          {resolvedPrimary}
        </OnboardingLink>
        <CtaReassurance className="mt-3" />
      </div>
