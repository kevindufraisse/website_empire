...
export default function WhatsAppBubble() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-5 right-5 z-[60] flex items-center gap-3 rounded-full border border-white/10 bg-[#111] py-2 pl-2 pr-4 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.9)] transition-all hover:scale-[1.03] hover:bg-[#161616] ${visible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}
    >
      <span className="relative flex h-10 w-10 items-center justify-center rounded-full bg-[#25D366]">
        ...
        <span className="absolute -right-0.5 -top-0.5 flex h-3 w-3">
          ...
          <span className="relative inline-flex h-3 w-3 rounded-full border-2 border-[#111] bg-emerald-400" />
        </span>
      </span>
