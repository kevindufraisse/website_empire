...
export const QUESTIONS: QuizQuestion[] = [
  ...
  },
  {
    id: 'learning',
    step: 6,
    kicker: 'Étape 6 / 7 · Apprentissage',
    question: 'Comment vous progressez le mieux dans la vie ?',
    helper: 'Pas de bonne réponse — chaque profil a son terrain.',
    options: [
      {
        id: 'self',
        label: 'En lisant et testant seul (autodidacte)',
        emoji: '📚',
        archetype: { educator: 2, builder: 1 },
        score: 3,
      },
      {
        id: 'observe',
        label: 'En regardant des créateurs faire en live (modèles)',
        emoji: '🎥',
        archetype: { storyteller: 2, provocateur: 1 },
        score: 4,
      },
      {
        id: 'doing',
        label: 'En faisant — j\'apprends en construisant, pas en théorisant',
        emoji: '🔨',
        archetype: { builder: 2 },
        score: 5,
      },
      {
        id: 'coach',
        label: 'Avec un coach qui me challenge en direct',
        emoji: '🤝',
        archetype: { storyteller: 1, educator: 1 },
        score: 7,
        pull: { copilot: 3 },
      },
      {
        id: 'mastermind',
        label: "Dans des cercles d'élite / mastermind",
        emoji: '🏆',
        archetype: { provocateur: 2, builder: 1 },
        score: 8,
        pull: { autopilot: 3, copilot: 1 },
      },
    ],
  },
  {
    id: 'revenue',
    step: 7,
    kicker: 'Étape 7 / 7 · Ambition',
    question: 'Votre objectif de revenus mensuels d\'ici 12 mois grâce au contenu :',
    options: [
      { id: 'lt2k', label: 'Moins de 2 000 €/mois', emoji: '🪴', score: 2, pull: { nurture: 2 } },
      { id: '2_5k', label: '2 000 à 5 000 €/mois', emoji: '💵', score: 4, pull: { academy: 2 } },
      { id: '5_10k', label: '5 000 à 10 000 €/mois', emoji: '💰', score: 6, pull: { copilot: 3 } },
      { id: '10_30k', label: '10 000 à 30 000 €/mois', emoji: '🚀', score: 8, pull: { copilot: 2, autopilot: 3 } },
      { id: 'gt30k', label: 'Plus de 30 000 €/mois', emoji: '👑', score: 10, pull: { autopilot: 5 } },
    ],
  },
]
