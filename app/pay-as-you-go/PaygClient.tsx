      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <section className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
            {SERVICES.map((s) => (
              <div
                key={s.title}
                className="group relative p-6 sm:p-7 rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.05] to-white/[0.02] hover:border-empire/30 hover:from-empire/[0.06] hover:to-empire/[0.02] transition-all cursor-default"
              >
                <div className="w-11 h-11 rounded-xl bg-empire/10 border border-empire/20 flex items-center justify-center mb-5 group-hover:bg-empire/15 group-hover:border-empire/30 transition-all">
        ...
        <section className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-16">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold">
              Ce que vous ne ferez{' '}
              <span className="text-red-400">plus jamais.</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {PAIN_POINTS.map((item) => (
              <div
                key={item}
                className="flex items-center gap-3 px-4 py-3.5 rounded-xl bg-red-500/[0.04] border border-red-500/10 hover:border-red-500/20 transition-all"
              >
        ...
        <section className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-8">
          <div className="rounded-2xl border border-empire/20 bg-gradient-to-r from-empire/[0.06] via-empire/[0.03] to-empire/[0.06] p-8 sm:p-10 text-center">
            <h3 className="text-xl sm:text-2xl font-extrabold mb-3">
              Prêt à arrêter de galérer avec votre contenu ?
            </h3>
            <p className="text-neutral-400 text-sm mb-6 max-w-md mx-auto">
              Lancez votre content machine en 5 minutes. On s&apos;occupe du reste.
            </p>
            <a
              href={ONBOARDING_URL}
              className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-empire text-black font-bold text-base hover:brightness-110 transition-all shadow-[0_0_30px_-6px_rgb(var(--empire-rgb)_/_0.4)]"
            >
              Recruter mon équipe
              <ArrowRight size={18} />
            </a>
        ...
        <section className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5">
            {[
              ...
              <div
                key={s.step}
                className="relative p-6 sm:p-7 rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.05] to-white/[0.02]"
              >
                <span className="text-6xl font-extrabold text-white/[0.04] absolute top-3 right-5 select-none">
                  {s.step}
                </span>
                <div className="w-11 h-11 rounded-xl bg-empire/10 border border-empire/20 flex items-center justify-center mb-5">
                  <s.icon size={20} className="text-empire" />
                </div>
                <h3 className="text-base font-bold text-white mb-2">{s.title}</h3>
                <p className="text-sm text-neutral-400 leading-relaxed">{s.desc}</p>
        ...
        {/* ── What's included + Final CTA ── */}
        <section className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            {/* Left: included features */}
            <div className="p-6 sm:p-8 rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.05] to-white/[0.02]">
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-4">
                Votre contenu,{' '}
                <span className="text-empire">en pilote automatique.</span>
              </h2>
              <p className="text-neutral-400 text-base leading-relaxed mb-6 max-w-md mx-auto lg:mx-0">
                Arrêtez de perdre du temps à produire du contenu. Concentrez-vous sur votre business,
                on s&apos;occupe de votre visibilité sur tous les réseaux.
              </p>

              <div className="flex items-center justify-between p-4 rounded-xl bg-white/[0.04] border border-white/10 mb-6 max-w-md mx-auto lg:mx-0">
                <div>
