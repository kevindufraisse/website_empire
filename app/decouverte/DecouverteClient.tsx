      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        <div className="border-b border-white/5">
          <div className="flex items-center justify-between max-w-5xl mx-auto w-full px-4 sm:px-6 py-4">
            <a href="/" className={`text-white font-bold text-base tracking-tight ${accent.hoverText} transition-colors`}>
              Empire Internet
            </a>
        ...
        <div className="flex-1 w-full max-w-5xl mx-auto px-4 sm:px-6 py-8 md:py-14 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div>
            <div className={`relative rounded-2xl border ${accent.formBorder} bg-gradient-to-b from-white/[0.08] to-white/[0.04] p-5 sm:p-7 ${accent.formShadow} overflow-hidden`}>
              ...
              <h2 className="text-lg font-bold text-white mb-5">{formTitle}</h2>
              <YtLeadForm />
            </div>
