...
export const fr: Translations = {
  ...
  howItWorks: {
    ...
    step1: {
      ...
      summary: 'Une IA vous interviewe. Vous vous présentez et répondez.',
      description: 'Zéro préparation. Zéro script. Notre IA pose des questions intelligentes qui extraient vos meilleures idées, histoires et expertise. C\'est comme parler à un collègue, pas à un robot.',
    ...
    step2: {
      title: 'IA Crée, Humains Peaufinent',
      summary: '30+ pièces générées, puis chacune peaufinée par un vrai éditeur.',
      description: 'L\'IA fait le gros du travail. Puis un vrai éditeur humain révise, peaufine et perfectionne chaque pièce avant qu\'elle ne vous parvienne. Pas de contenu robotique. Juste votre voix, amplifiée.',
    ...
    step3: {
      ...
      summary: 'Tout est prêt dans votre calendrier. Relisez et publiez quand vous voulez.',
      description: 'Tout le contenu est pré-planifié aux meilleurs moments dans votre calendrier partagé. Vous êtes notifié quand c\'est prêt. Relisez (ou sautez), puis publiez en un clic. Prend 30 secondes.',
      badge1: 'Pré-planifié',
      badge1Sub: 'Horaires optimaux',
      badge2: 'Relisez quand vous voulez',
      badge2Sub: 'Vous gardez le contrôle',
      badge3: 'Publication en 1 clic',
      badge3Sub: '30 secondes max',
    },
  },
  features: {
