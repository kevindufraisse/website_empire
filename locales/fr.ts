...
export const fr: Translations = {
  ...
  header: {
    ...
    joinQA: 'Rejoindre Q&A (Mar/Jeu 13h30)',
    formats: 'Formats',
    product: 'Produit',
  ...
  faqItems: [
    {
      ...
      answer: 'Deux façons : 1) Rejoignez le Q&A live (Mardi/Jeudi 13h30 CET) pour tout voir, OU 2) Allez sur la page de commande et choisissez votre plan. Votre premier contenu est prêt 24h après votre interview.',
    },
    {
  ...
  demo: {
    title: 'Demo Empire internet',
    titleWith: 'W/ Kevin Dufraisse',
    subtitle: 'Rejoignez-moi pour une démo live d\'Empire internet ! 🎉 Une heure d\'action où vous verrez la plateforme en action—pas de slides, pas de blabla, juste un vrai walkthrough de ce que cette chose peut faire.',
    step1: 'Choisissez votre créneau',
    step2: 'Répondez aux questions',
    step3: 'Vos informations',
    dateLabel: 'Choisissez votre créneau *',
    dateTime: '13:30 - 14:30 UTC+1 (Paris)',
    ...
    questionsPlaceholder: 'Avez-vous des questions spécifiques que vous aimeriez aborder pendant la démo ?',
    ...
    aboutText1: 'Kevin Dufraisse vous présente une démo live d\'Empire internet ! 🎉 Préparez-vous pour une heure d\'action où vous verrez la plateforme en pleine action—pas de slides, pas de blabla, juste un vrai walkthrough de ce que cette chose peut réellement faire. Que vous soyez curieux de ses capacités ou déjà plongé dans la recherche, c\'est votre chance de voir Kevin faire sa magie et obtenir vos questions brûlantes répondues en temps réel.',
    aboutText2: 'On garde les choses décontractées et interactives sur Zoom, alors apportez votre curiosité (et votre café) ! Kevin est connu pour expliquer les choses d\'une manière qui a du sens, alors attendez-vous à une démo qui est à la fois informative et divertissante. Posez vos questions, partagez vos pensées, ou asseyez-vous et profitez—comme vous voulez ! 🚀',
    aboutPresentedBy: 'Présenté par',
  },
  demoThankYou: {
    title: 'C\'est dans la poche ! 🎉',
    subtitle: 'Votre place pour la démo live est réservée. On se voit bientôt !',
    checkEmail: {
    ...
    share: {
      ...
      shareText: 'Rejoins-moi pour une démo live d\'Empire internet ! 🎉',
      copied: 'Lien copié dans le presse-papier !',
    },
    community: {
      title: 'Rejoignez la communauté privée',
      desc: 'En attendant la démo, rejoignez notre communauté privée sur Skool pour échanger avec d\'autres créateurs et avoir un aperçu exclusif d\'Empire !',
