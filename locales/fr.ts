...
export const fr: Translations = {
  exitPopup: {
    ...
    ctaSchedule: 'Commencer gratuitement',
  ...
  hero: {
    ...
    creatorsCost: 'Pour 10x moins cher.',
    creatorsYouPay: '',
  ...
  howItWorksPage: {
    ...
    step4Desc: 'Vous publiez, on optimise',
    platformsTitle: 'Contenu créé pour toutes vos plateformes',
  ...
  howItWorks: {
    ...
    step3: {
      ...
      summary: 'Notre équipe crée vos contenus du mois. Des humains vérifient chaque pièce.',
      description: 'On rédige et on monte vos contenus, puis un expert vérifie et peaufine chaque pièce. Tout est pré-planifié dans votre calendrier - relisez et publiez en 1 clic.',
      badge1: 'Pré-planifié',
  ...
  finalCTA: {
    limited: '',
    title: 'Vous avez le message. Le reste est déjà construit.',
    subtitle: '',
  ...
  objections: {
    ...
    concerns: [
      ...
      },
      {
        ...
        answer: 'Oui. Embaucher = €12K+/mois, semaines d\'intégration, et vous devez les gérer. Empire = contenu quotidien sur toutes les plateformes, zéro gestion. Liste d\'attente : on sélectionne les profils les plus motivés.',
      },
      {
  ...
  bentoGrid: {
    ...
    voiceContentDesc: 'Yapping face caméra, interviews guidées ou faux QA clients. Zéro préparation.',
    recording: 'ENREGISTREMENT...',
    contentReady: 'Contenu prêt chaque jour',
    contentReadyDesc: 'Nouveau contenu créé et planifié automatiquement chaque semaine.',
    multiPlatform: 'On multiplie sur tous les réseaux',
    multiPlatformDesc: 'Un contenu = LinkedIn, Instagram, TikTok, YouTube, X, Threads, Facebook. Partout, en même temps.',
    calendar: 'Publiez en 1 clic',
    calendarDesc: 'Tout est ajouté à votre calendrier. Vous validez, vous publiez en 1 clic. Rien à gérer.',
    contentScheduled: '1 clic pour publier',
  ...
  founder: {
    ...
    bio: 'Plus de 3 M€ générés en ligne avec du contenu et du copywriting. Un an à décortiquer les meilleurs créateurs du monde pour comprendre ce qui rend un contenu viral. Puis j\'ai transformé ces mécaniques en un système que n\'importe qui peut faire tourner en 20 minutes par semaine - à commencer par moi : plus d\'un million de vues par mois sur mes comptes avec ce système.',
  ...
  autopilot: {
    ...
    howItWorks: {
      ...
      b3: {
        title: 'On publie pour vous',
        desc: 'Sur vos 7 réseaux, aux bons horaires. Vous ne touchez à rien.',
      },
      b4: {
