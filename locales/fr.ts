...
export const fr: Translations = {
  ...
  header: {
    spots: '83/100 places',
    watchDemo: 'Audit de Contenu Gratuit',
    getAccess: 'Obtenir l\'Accès',
    joinQA: 'Audit de Contenu Gratuit',
    formats: 'Formats',
    product: 'Produit',
  ...
  hero: {
    ...
    cta1: 'Audit de Contenu Gratuit',
    cta2: 'Voir la Démo (20 min)',
    auditBullet1: 'Bilan complet de votre stratégie de contenu',
    auditBullet2: 'Plan d\'action concret pour percer sur les réseaux',
    auditBullet3: 'Si vous êtes un bon fit, vous pourrez rejoindre Empire',
  ...
  finalCTA: {
    ...
    startNow: 'Audit de Contenu Gratuit',
    watchDemo: 'Audit de Contenu Gratuit',
