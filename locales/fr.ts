...
export const fr: Translations = {
  exitPopup: {
    ...
    ctaSchedule: 'Parler à un expert',
  ...
  header: {
    spots: '83/100 places',
    watchDemo: 'Parler à un expert',
    getAccess: 'Obtenir l\'Accès',
    joinQA: 'Parler à un expert',
    formats: 'Formats',
    product: 'Produit',
  ...
  hero: {
    ...
    creatorsTitle: 'Ces créateurs dépensent 50-100K€/mois en contenu',
    creatorsCost: 'On vous livre le même résultat pour 10x moins.',
    creatorsYouPay: '',
