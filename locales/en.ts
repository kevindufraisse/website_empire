export const en = {
  header: {
    ...
    joinQA: 'Join Q&A (Tue/Thu 1:30PM)',
    formats: 'Formats',
    product: 'Product',
  ...
  faqItems: [
    {
      ...
      answer: 'Two ways: 1) Join our live Q&A session (Tuesday 1:30PM or Thursday 1:30PM CET) to see everything and ask questions, OR 2) Go directly to our order page and choose your plan. Either way, your first content is ready within 24 hours of your interview.',
    },
    {
  ...
  exitPopup: {
    ...
    ctaSchedule: 'Tue/Thu 1:30PM CET',
  ...
  demo: {
    ...
    subtitle: 'Join me for a live demo of Empire internet! 🎉 An hour of action where you\'ll see the platform in action—no slides, no fluff, just a real walkthrough of what this thing can do.',
    step1: 'Choose your slot',
    step2: 'Answer questions',
    step3: 'Your information',
    dateLabel: 'Choose your slot *',
    ...
    aboutText1: 'Kevin Dufraisse is bringing the heat with a live demo of Empire internet! 🎉 Get ready for an action-packed hour where you\'ll see the platform in full swing—no slides, no fluff, just a straight-up walkthrough of what this thing can actually do. Whether you\'re curious about its capabilities or already knee-deep in research, this is your chance to watch Kevin work his magic and get your burning questions answered in real time.',
    aboutText2: 'We\'re keeping things casual and interactive on Zoom, so bring your curiosity (and your coffee)! Kevin\'s known for breaking things down in a way that actually makes sense, so expect a demo that\'s equal parts informative and entertaining. Fire away with questions, share your thoughts, or just sit back and take it all in—however you want to roll with it works for us. See you there! 🚀',
    aboutPresentedBy: 'Presented by',
  },
  demoThankYou: {
    title: 'You\'re In! 🎉',
    subtitle: 'Your spot for the live demo is reserved. See you soon!',
    checkEmail: {
    ...
    share: {
      ...
      shareText: 'Join me for a live demo of Empire internet! 🎉',
      copied: 'Link copied to clipboard!',
    },
    community: {
      title: 'Join the private community',
      desc: 'While waiting for the demo, join our private community on Skool to connect with other creators and get an exclusive preview of Empire!',
