export const en = {
  ...
  howItWorks: {
    ...
    step1: {
      ...
      summary: 'AI interviews you. You just show up and answer.',
      description: 'Zero prep. Zero script. Our AI asks smart questions that extract your best insights, stories, and expertise. It feels like talking to a colleague, not a robot.',
    ...
    step2: {
      title: 'AI Creates, Humans Polish',
      summary: '30+ pieces generated, then every single one polished by a real editor.',
      description: 'AI does the heavy lifting. Then a real human editor reviews, polishes, and perfects every piece before it reaches you. No robotic content. Just your voice, amplified.',
    ...
    step3: {
      ...
      summary: 'Everything ready in your calendar. Review and publish when you want.',
      description: 'All content is pre-scheduled at optimal times in your shared calendar. You get notified when it\'s ready. Review it (or skip), then one-click publish. Takes 30 seconds.',
